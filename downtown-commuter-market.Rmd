...
This map shows total jobs in the downtown Minneapolis area in 2017. Colors are logged, labels show unlogged values. **This shape/area might need to be adjusted to better reflect what we consider 'broader downtown'**. 
```{r}
# total jobs in 2017 ------------------
...
This map shows the origins of employees who work in the region above in 2017. There are lots of counties much further away with 1-3 employees listed but I'm guessing those people are, for the most part, not actually commuting daily. I included existing park & ride lots as well. 
```{r}
